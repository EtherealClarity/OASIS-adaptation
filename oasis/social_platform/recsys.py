...
twhin_tokenizer = AutoTokenizer.from_pretrained(
    pretrained_model_name_or_path="/home/dengshisong/Projects/oasis-adaptation/recsys_model/twhin-bert-base/",
    model_max_length=512)  # TODO change the pretrained_model_path
twhin_model = AutoModel.from_pretrained(
    pretrained_model_name_or_path="/home/dengshisong/Projects/oasis-adaptation/recsys_model/twhin-bert-base/").to(device)
